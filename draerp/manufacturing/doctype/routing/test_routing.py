...
from draerp.manufacturing.doctype.job_card.job_card import OperationSequenceError
...
def setup_operations(rows):
	from draerp.manufacturing.doctype.operation.test_operation import make_operation
	from draerp.manufacturing.doctype.workstation.test_workstation import make_workstation
