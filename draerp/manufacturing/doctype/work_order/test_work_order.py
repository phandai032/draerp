...
from draerp.manufacturing.doctype.job_card.job_card import JobCardCancelError
...
from draerp.stock.doctype.stock_entry import test_stock_entry
...
class TestWorkOrder(FrappeTestCase):
	...
	def test_wo_completion_with_pl_bom(self):
		from draerp.manufacturing.doctype.bom.test_bom import (
