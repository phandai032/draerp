...
from draerp.accounts.party import (  # noqa
	get_dashboard_info,
	get_timeline_data,
...
class Supplier(TransactionBase):
	...
	def create_primary_contact(self):
		from draerp.selling.doctype.customer.customer import make_contact
	...
	def create_primary_address(self):
		...
		from draerp.selling.doctype.customer.customer import make_address
