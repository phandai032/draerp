...
draerp.selling.QuotationController = class QuotationController extends draerp.selling.SellingController {
	onload(doc, dt, dn) {
	...
	get_lead_details() {
		...
		frappe.call({
			method: "draerp.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(draerp.selling.QuotationController);
