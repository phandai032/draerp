...
from draerp.accounts.party import get_due_date
from draerp.exceptions import PartyDisabled, PartyFrozen
from draerp.selling.doctype.customer.customer import get_credit_limit, get_customer_outstanding
from draerp.tests.utils import create_test_contact_and_address
...
class TestCustomer(FrappeTestCase):
	...
	def test_party_details(self):
		from draerp.accounts.party import get_party_details
	...
	def test_serach_fields_for_customer(self):
		from draerp.controllers.queries import customer_query
