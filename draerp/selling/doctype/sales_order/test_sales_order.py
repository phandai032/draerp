...
from draerp.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from draerp.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
	make_maintenance_visit,
)
from draerp.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from draerp.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
...
class TestSalesOrder(FrappeTestCase):
	...
	def test_drop_shipping(self):
		from draerp.buying.doctype.purchase_order.purchase_order import update_status
		from draerp.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from draerp.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from draerp.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_serial_no_based_delivery(self):
		...
		from draerp.manufacturing.doctype.production_plan.test_production_plan import make_bom
		...
		so.submit()
		from draerp.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
		...
		from draerp.manufacturing.doctype.work_order.work_order import (
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from draerp.controllers.item_variant import create_variant
		from draerp.manufacturing.doctype.production_plan.test_production_plan import make_bom
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from draerp.stock.doctype.material_request.material_request import raise_work_orders
