...
from draerp.accounts.doctype.cash_flow_mapper.default_cash_flow_mapper import DEFAULT_MAPPERS
from draerp.setup.default_energy_point_rules import get_default_energy_point_rules

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://draerp.org">DraERP</a></div>"""
...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """DraERP can only be installed on a fresh site where the setup wizard is not completed.
...
def add_standard_navbar_items():
	...
	draerp_navbar_items = [
		{
			...
			"item_type": "Route",
			"route": "https://draerp.com/docs/user/manual",
			"is_standard": 1,
		},
		{
			"item_label": "User Forum",
			"item_type": "Route",
			"route": "https://discuss.draerp.com",
			"is_standard": 1,
		},
		{
			"item_label": "Report an Issue",
			"item_type": "Route",
			"route": "https://github.com/frappe/draerp/issues",
			"is_standard": 1,
		},
	]
	...
	for item in draerp_navbar_items:
...
def add_app_name():
	frappe.db.set_value("System Settings", None, "app_name", "DraERP")
