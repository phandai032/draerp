...
from draerp.accounts.utils import get_currency_precision
...
class ReceivablePayableReport(object):
    ...
    def init_voucher_balance(self):
        ...
        for gle in self.gl_entries:
            ...
            key = (gle.voucher_type, gle.voucher_no, gle.party, gle.account)
    ...
    def get_voucher_balance(self, gle):
        ...
        if not voucher_balance:
            ...
            voucher_balance = self.voucher_balance.get((gle.voucher_type, gle.voucher_no, gle.party, gle.account ))
    ...
    def get_gl_entries(self):
        ...
        self.gl_entries = frappe.db.sql("""
			select
				name, posting_date, account, party_type, party, voucher_type, voucher_no, account, cost_center,
    ...
    def get_columns(self):
        ...
        self.add_column(label=_('Account'), fieldname='account', fieldtype='Data')
