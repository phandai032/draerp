...
draerp.selling.POSInvoiceController = class POSInvoiceController extends draerp.selling.SellingController {
	setup(doc) {
...
extend_cscript(cur_frm.cscript, new draerp.selling.POSInvoiceController({ frm: cur_frm }))
