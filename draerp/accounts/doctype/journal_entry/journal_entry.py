...
import draerp
from draerp.accounts.deferred_revenue import get_deferred_booking_accounts
...
from draerp.accounts.utils import (
...
class JournalEntry(AccountsController):
	...
	def apply_tax_withholding(self):
		from draerp.accounts.report.general_ledger.general_ledger import get_account_type_map
...
def get_default_bank_cash_account(company, account_type=None, mode_of_payment=None, account=None):
	from draerp.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
...
def get_outstanding(args):
	...
	company_currency = draerp.get_company_currency(args.get("company"))
	due_date = None
...
def get_account_balance_and_party_type(
	...
	company_currency = draerp.get_company_currency(company)
	account_details = frappe.db.get_value(
