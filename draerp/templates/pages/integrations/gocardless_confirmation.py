...
from draerp.draerp_integrations.doctype.gocardless_settings.gocardless_settings import (
...
def create_mandate(data):
	...
	if frappe.db.exists("GoCardless Mandate", mandate):
		...
		draerp_customer = frappe.db.get_value(
			...
			frappe.get_doc(
				{
					...
					"mandate": mandate,
					"customer": draerp_customer.customer_name,
