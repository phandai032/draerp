...
def task(doc_name, from_doctype, to_doctype):
	from draerp.accounts.doctype.payment_entry import payment_entry
	from draerp.accounts.doctype.purchase_invoice import purchase_invoice
	from draerp.accounts.doctype.sales_invoice import sales_invoice
	from draerp.buying.doctype.purchase_order import purchase_order
	from draerp.buying.doctype.supplier_quotation import supplier_quotation
	from draerp.selling.doctype.quotation import quotation
	from draerp.selling.doctype.sales_order import sales_order
	from draerp.stock.doctype.delivery_note import delivery_note
	from draerp.stock.doctype.purchase_receipt import purchase_receipt
