...
from draerp.assets.doctype.asset.asset import get_asset_account
from draerp.assets.doctype.asset.test_asset import (
	create_asset,
	create_asset_data,
...
class TestAssetRepair(unittest.TestCase):
	...
	def test_serialized_item_consumption(self):
		from draerp.stock.doctype.serial_no.serial_no import SerialNoRequiredError
