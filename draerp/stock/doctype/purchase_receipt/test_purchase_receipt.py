...
import draerp
from draerp.accounts.doctype.account.test_account import get_inventory_account
from draerp.controllers.buying_controller import QtyMismatchError
from draerp.stock.doctype.item.test_item import create_item, make_item
from draerp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from draerp.stock.doctype.serial_no.serial_no import SerialNoDuplicateError, get_serial_nos
from draerp.stock.doctype.warehouse.test_warehouse import create_warehouse
from draerp.stock.stock_ledger import SerialNoExistsInFutureTransaction
...
class TestPurchaseReceipt(FrappeTestCase):
	...
	def test_purchase_receipt_no_gl_entry(self):
		from draerp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(draerp.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_for_rejected_qty(self):
		from draerp.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from draerp.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from draerp.buying.doctype.purchase_order.purchase_order import (
			make_purchase_invoice as make_purchase_invoice_from_po,
		)
		from draerp.buying.doctype.purchase_order.purchase_order import make_purchase_receipt
		from draerp.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_purchase_return_with_submitted_asset(self):
		from draerp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from draerp.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from draerp.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from draerp.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from draerp.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from draerp.accounts.doctype.payment_entry.test_payment_entry import (
			create_payment_terms_template,
		)
		from draerp.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
		from draerp.buying.doctype.purchase_order.test_purchase_order import (
			create_purchase_order,
			make_pr_against_po,
		)
		from draerp.selling.doctype.sales_order.test_sales_order import (
	...
	def test_neg_to_positive(self):
		from draerp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
	...
	def test_backdated_transaction_for_internal_transfer(self):
		from draerp.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from draerp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from draerp.accounts.doctype.sales_invoice.sales_invoice import (
...
def prepare_data_for_internal_transfer():
	from draerp.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
