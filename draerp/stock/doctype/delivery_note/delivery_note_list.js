frappe.listview_settings['Delivery Note'] = {
	...
	onload: function (listview) {
		...
		listview.page.add_action_item(__("Sales Invoice"), ()=>{
			draerp.bulk_transaction_processing.create(listview, "Delivery Note", "Sales Invoice");
		});

		listview.page.add_action_item(__("Packaging Slip From Delivery Note"), ()=>{
			draerp.bulk_transaction_processing.create(listview, "Delivery Note", "Packing Slip");
		});
	}
};
