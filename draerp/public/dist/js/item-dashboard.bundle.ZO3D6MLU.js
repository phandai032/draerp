(() => {
  // frappe-html:/home/bench/draerp/apps/draerp/draerp/stock/dashboard/item_dashboard.html
...
`;
  ...
  // frappe-html:/home/bench/draerp/apps/draerp/draerp/stock/dashboard/item_dashboard_list.html
...
`;
  ...
  // ../draerp/draerp/stock/dashboard/item_dashboard.js
  frappe.provide("draerp.stock");
  draerp.stock.ItemDashboard = class ItemDashboard {
    constructor(opts) {
      $.extend(this, opts);
      this.make();
    }
      ...
      function handle_move_add(element, action) {
        ...
        if (disable_quick_entry) {
          ...
          if (action === "Add") {
            ...
            draerp.stock.move_item(item, null, warehouse, actual_qty, rate, function() {
              me.refresh();
            });
          } else {
            draerp.stock.move_item(item, warehouse, null, actual_qty, null, function() {
              me.refresh();
            });
          }
        }
  ...
  draerp.stock.move_item = function(item, source, target, actual_qty, rate, callback) {
  ...
  // frappe-html:/home/bench/draerp/apps/draerp/draerp/stock/page/warehouse_capacity_summary/warehouse_capacity_summary.html
...
`;
  ...
  // frappe-html:/home/bench/draerp/apps/draerp/draerp/stock/page/warehouse_capacity_summary/warehouse_capacity_summary_header.html
...
//# sourceMappingURL=item-dashboard.bundle.ZO3D6MLU.js.map
