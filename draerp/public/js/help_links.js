...
const docsUrl = "https://draerp.com/docs/";
...
frappe.help.help_links["Form/PayPal Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/draerp_integration/paypal-integration",
	},
];
...
frappe.help.help_links["Form/Razorpay Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/draerp_integration/razorpay-integration",
	},
];
...
frappe.help.help_links["Form/LDAP Settings"] = [
	{
		label: "LDAP Settings",
		url:
			docsUrl + "user/manual/en/draerp_integration/ldap-integration",
	},
];
...
frappe.help.help_links["Form/Stripe Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/draerp_integration/stripe-integration",
	},
];
