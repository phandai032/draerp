frappe.provide("draerp.timesheet");

draerp.timesheet.timer = function(frm, row, timestamp=0) {
	...
	draerp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

draerp.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
